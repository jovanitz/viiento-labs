...
describe('the rpc pipeline', () => {
  ...
  it('declares every access capability in the registry', () => {
    expect(
      ...
      'bison.clients.get',
      'bison.clients.list',
      'bison.clients.updateContact',
      'bison.documents.attachPdf',
      'bison.documents.issue',
      'bison.documents.issues',
      'bison.documents.void',
      'bison.files.attach',
      ...
      'bison.formats.save',
      'bison.identity.get',
      'bison.identity.update',
      'bison.templates.create',
      'bison.templates.get',
      'bison.templates.list',
      'bison.templates.update',
      'bison.timeline.list',
      'bison.timeline.log',
      'customer.read',
      'customer.search',
